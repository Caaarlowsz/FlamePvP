...
public class GuiLoja implements Listener
{
    ...
    public void inventarioKit(final InventoryClickEvent e) {
        ...
        if (e.getInventory().getTitle().equalsIgnoreCase("§cLoja De Kit") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            ...
            API.venderItem(e, p, Material.BAKED_POTATO, 20000, "§7Voc\u00ea comprou o kit: §bHotPotato", "kit.hotpotato");
        }
    }
    ...
    public void inventariocaixa(final InventoryClickEvent e) {
        final Player p = (Player)e.getWhoClicked();
        if (e.getInventory().getTitle().equalsIgnoreCase("§eLoja De Caixa") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            if (e.getCurrentItem().getType() == Material.STAINED_GLASS_PANE) {
                e.setCancelled(true);
                return;
