		...
		if (label.equalsIgnoreCase("setarena")) {
			if (p.hasPermission("kitpvp.staff")) {
				...
				if (args[0].equalsIgnoreCase("1")) {
					...
					Main.getInstance().arenas.set("arena1.x", p.getLocation().getX());
					Main.getInstance().arenas.set("arena1.y", p.getLocation().getY());
					Main.getInstance().arenas.set("arena1.z", p.getLocation().getZ());
					p.getWorld();
					Main.getInstance().arenas.set("arena1.pitch", p.getLocation().getPitch());
					Main.getInstance().arenas.set("arena1.yaw", p.getLocation().getYaw());
				...
				if (args[0].equalsIgnoreCase("2")) {
					...
					Main.getInstance().arenas.set("arena2.x", p.getLocation().getX());
					Main.getInstance().arenas.set("arena2.y", p.getLocation().getY());
					Main.getInstance().arenas.set("arena2.z", p.getLocation().getZ());
					p.getWorld();
					Main.getInstance().arenas.set("arena2.pitch", p.getLocation().getPitch());
					Main.getInstance().arenas.set("arena2.yaw", p.getLocation().getYaw());
				...
				if (args[0].equalsIgnoreCase("3")) {
					...
					Main.getInstance().arenas.set("arena3.x", p.getLocation().getX());
					Main.getInstance().arenas.set("arena3.y", p.getLocation().getY());
					Main.getInstance().arenas.set("arena3.z", p.getLocation().getZ());
					p.getWorld();
					Main.getInstance().arenas.set("arena3.pitch", p.getLocation().getPitch());
					Main.getInstance().arenas.set("arena3.yaw", p.getLocation().getYaw());
				...
				if (args[0].equalsIgnoreCase("4")) {
					...
					Main.getInstance().arenas.set("arena4.x", p.getLocation().getX());
					Main.getInstance().arenas.set("arena4.y", p.getLocation().getY());
					Main.getInstance().arenas.set("arena4.z", p.getLocation().getZ());
					p.getWorld();
					Main.getInstance().arenas.set("arena4.pitch", p.getLocation().getPitch());
					Main.getInstance().arenas.set("arena4.yaw", p.getLocation().getYaw());
				...
				if (args[0].equalsIgnoreCase("5")) {
					...
					Main.getInstance().arenas.set("arena5.x", p.getLocation().getX());
					Main.getInstance().arenas.set("arena5.y", p.getLocation().getY());
					Main.getInstance().arenas.set("arena5.z", p.getLocation().getZ());
					p.getWorld();
					Main.getInstance().arenas.set("arena5.pitch", p.getLocation().getPitch());
					Main.getInstance().arenas.set("arena5.yaw", p.getLocation().getYaw());
