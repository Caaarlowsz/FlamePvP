        ...
        if (label.equalsIgnoreCase("kit")) {
            ...
            if (args[0].equalsIgnoreCase("pvp")) {
                if (p.hasPermission("kit.pvp")) {
                    ...
                    p.sendMessage(String.valueOf(String.valueOf(API.preffix)) + "§7Voc\u00ea pegou o kit: §b" + Habilidade.getAbility(p));
            ...
            if (args[0].equalsIgnoreCase("teleporter")) {
                if (p.hasPermission("kit.teleporter")) {
                    p.getInventory().clear();
                    API.darItem(p, Material.STONE_SWORD, 1, "§7Espada", 0);
                    API.darItemEnchant(p, Material.BOW, 1, "§7Kit §eTeleporter", 1, Enchantment.ARROW_INFINITE, 1, true);
