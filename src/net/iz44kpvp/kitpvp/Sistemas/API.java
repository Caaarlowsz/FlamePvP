...
public class API {
	...
	static {
		API.Motd = FlamePvP.getInstance().getConfig().getString("Motd").replace("&", "�");
		API.StatusMotd = FlamePvP.getInstance().getConfig().getString("StatusMotd").replace("&", "�");
		API.NomeServer = FlamePvP.getInstance().getConfig().getString("NomeServer").replace("&", "�");
		API.AutoM1 = FlamePvP.getInstance().getConfig().getString("MensagemAutomatica1").replace("&", "�");
		API.AutoM2 = FlamePvP.getInstance().getConfig().getString("MensagemAutomatica2").replace("&", "�");
		API.AutoM3 = FlamePvP.getInstance().getConfig().getString("MensagemAutomatica3").replace("&", "�");
		API.AutoM4 = FlamePvP.getInstance().getConfig().getString("MensagemAutomatica4").replace("&", "�");
		API.AutoM5 = FlamePvP.getInstance().getConfig().getString("MensagemAutomatica5").replace("&", "�");
		API.MSGAplicar1 = FlamePvP.getInstance().getConfig().getString("MensagemAplicar1").replace("&", "�");
		API.MSGYoutuber1 = FlamePvP.getInstance().getConfig().getString("MensagemYoutuber1").replace("&", "�");
		API.MSGYoutuber2 = FlamePvP.getInstance().getConfig().getString("MensagemYoutuber2").replace("&", "�");
		API.MSGYoutuber3 = FlamePvP.getInstance().getConfig().getString("MensagemYoutuber3").replace("&", "�");
	...
	public static void novaReceita() {
		...
		Bukkit.getServer().addRecipe(SopaNormal);
	}
