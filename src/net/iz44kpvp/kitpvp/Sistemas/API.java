...
public class API
{
    ...
    static {
        ...
        API.fimcooldown = String.valueOf(String.valueOf(API.preffix)) + "§aVoc\u00ea n\u00e3o est\u00e1 mais em cooldown";
    ...
    public static void MensagemCooldown(final Player p) {
        p.sendMessage(String.valueOf(String.valueOf(API.preffix)) + "§bVoc\u00ea est\u00e1 em cooldown de: §5" + Cooldown.cooldown(p) + "§bs");
    }
    ...
    public static void venderItem(final InventoryClickEvent e, final Player p, final Material materialdoinv, final int pre\u00e7o, final String coisacomprada, final String permissao) {
        if (e.getCurrentItem().getType() == materialdoinv) {
            ...
            if (KillsDeathsRankXp.getXp(p) >= pre\u00e7o) {
                ...
                p.sendMessage(String.valueOf(String.valueOf(API.preffix)) + "§cVoc\u00ea n\u00e3o possui xp suficiente");
            }
        }
    }
